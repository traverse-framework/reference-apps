...
| **loop** | WF1 follow-through: ingest → extract → normalize → authorize (human review) | [web](apps/loop/web-react/) · [all OS](#by-os--target) |
...
| loop | [link](apps/loop/web-react/) | [link](apps/loop/macos-swift/) | [link](apps/loop/ios-swift/) | [link](apps/loop/android-compose/) | [link](apps/loop/windows-winui/) | [link](apps/loop/linux-gtk/) | [link](apps/loop/cli-rust/) |
