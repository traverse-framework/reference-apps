...
| **Adopted / secondary** | `browser-consumer`, `youaskm3-starter-kit`, `llm-mcp-reference` | Lighter demo smokes only — **not** merge-blocking `embedded_smoke` targets (`android-demo`/`macos-demo`/`react-demo` retired) |
