...
| `loop-wf1-registry-deps` | **In Progress** | Digest inventory in `docs/loop-registry-deps.md` |
| `loop-wf1-multi-os` | Ready (after deps merge) | `apps/loop/` WF1 × 7 OS; compose via `registry_ref` |
