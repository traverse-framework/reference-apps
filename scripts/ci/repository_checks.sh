...
check "scripts/ci/fixtures/traverse-starter-smoke-agents/digests.json" "Smoke agent digests"
check "scripts/ci/fixtures/traverse-starter-smoke-agents/process-agent.wasm" "Smoke process agent wasm"
