...
check "apps/loop/web-react/README.md"                          "loop web-react README"
check "apps/loop/ios-swift/Loop.xcodeproj"                     "loop ios-swift Xcode project"
check "apps/loop/ios-swift/README.md"                          "loop ios-swift README"
check "apps/loop/macos-swift/LoopMac.xcodeproj"                "loop macos-swift Xcode project"
check "apps/loop/macos-swift/README.md"                        "loop macos-swift README"
check "apps/loop/android-compose/settings.gradle.kts"          "loop android-compose Gradle project"
check "apps/loop/android-compose/README.md"                    "loop android-compose README"
check "apps/loop/windows-winui/Loop.sln"                       "loop windows-winui solution"
check "apps/loop/windows-winui/README.md"                      "loop windows-winui README"
check "apps/loop/linux-gtk/Cargo.toml"                         "loop linux-gtk Cargo project"
check "apps/loop/linux-gtk/README.md"                          "loop linux-gtk README"
check "apps/loop/cli-rust/Cargo.toml"                          "loop cli-rust Cargo project"
check "apps/loop/cli-rust/README.md"                           "loop cli-rust README"
check "apps/loop/LoopCore/Package.swift"                       "loop LoopCore package"
check "apps/loop/loop-core-rs/Cargo.toml"                      "loop-core-rs Cargo crate"
check "apps/loop/Cargo.toml"                                   "loop Cargo workspace"
check "manifests/loop/app.manifest.json"                       "loop app manifest"
check "manifests/loop/components/process/component.manifest.json" "loop process component"
check "manifests/loop/components/extract/component.manifest.json" "loop extract component"
check "manifests/loop/components/normalize/component.manifest.json" "loop normalize component"
check "manifests/loop/components/authorize/component.manifest.json" "loop authorize component"
check "manifests/loop/workflows/wf1/workflow.json"             "loop WF1 workflow"
...
check "scripts/ci/prepare_embedded_smoke_bundle.sh" "Embedded smoke prepare"
check "scripts/ci/pin_traverse_starter_smoke_agents.sh" "Pin Traverse starter smoke agents"
check "scripts/ci/fixtures/traverse-starter-smoke-agents/digests.json" "Smoke agent digests (Traverse provenance)"
check "scripts/ci/fixtures/traverse-starter-smoke-agents/process-agent.wasm" "Pinned Traverse process agent wasm"
...
check "scripts/ci/sync_web_loop_bundle.sh" "Web loop bundle sync"
...
check "scripts/ci/sync_winui_loop_bundle.sh" "WinUI loop bundle sync"
...
check "scripts/ci/sync_swift_loop_bundle.sh" "Swift loop bundle sync"
