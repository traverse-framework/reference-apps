...
**Runtime mode: HTTP sidecar (temporary carve-out)** — web-only until Project 2 `meeting-notes-multi-os`. This is a **primary product shell** (list-type output); sidecar is interim only — see [`docs/traverse-runtime.md`](../../../docs/traverse-runtime.md) and [`docs/production-playbook.md`](../../../docs/production-playbook.md).
