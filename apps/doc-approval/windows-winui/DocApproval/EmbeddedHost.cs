...
public interface IEmbeddedHost : IDisposable
{
    ...
    bool IsReady { get; }
    HostRunResult SubmitDocument(string document);
}
...
public static class EmbeddedHost
{
    ...
    public const string DefaultWorkflowId = "doc-approval.pipeline";
    public const string DefaultWorkspace = "local-default";
    public const string DefaultAppId = "doc-approval";

    public const string PinnedRuntimeWasmDigest =
        "sha256:aa801023ba4eb20b8c1b4004bdd964a78fed9540478b252b77eac04c80811852";

    public const string DefaultRelativeBundlePath = "Assets/bundles/doc-approval";
    ...
    private sealed class ProductionEmbeddedHost : IEmbeddedHost
    {
        ...
        public HostRunResult SubmitDocument(string document)
        {
            var input = new JsonObject { ["document"] = document }.ToJsonString();
        ...
        private HostRunResult DrainEvents(string sessionId)
        {
            ...
            return new HostRunResult(sessionId, output ?? DocApprovalOutput.Empty, events, null);
        }
    ...
    private sealed class TestEmbeddedHost : IEmbeddedHost
    {
        ...
        public HostRunResult SubmitDocument(string document)
        {
            ...
            foreach (var evt in runtimeEvents)
            {
                ...
                {
                    output = JsonSerializer.Deserialize<DocApprovalOutput>(evt.Output, JsonOptions)
                        ?? DocApprovalOutput.Empty;
                    break;
                }
            }
            ...
            return new HostRunResult(
                accepted.SessionId,
                output ?? DocApprovalOutput.Empty,
                events,
    ...
    private static DocApprovalOutput ParseOutput(JsonElement? data)
    {
        if (data is null)
        {
            return DocApprovalOutput.Empty;
        }
        ...
        return JsonSerializer.Deserialize<DocApprovalOutput>(element.GetRawText(), JsonOptions)
            ?? DocApprovalOutput.Empty;
    }
